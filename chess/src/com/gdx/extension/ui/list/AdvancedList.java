...
public class AdvancedList<T extends ListRow> extends VerticalGroup
{
    ...
    @Deprecated
    @Override
    public void addActor(Actor actor) { throw new OptimizationException("Use addItem(ListRow) instead."); }
    
    @Deprecated
    @Override
    public void addActorAfter(Actor actorAfter, Actor actor) { throw new OptimizationException("Use addItem(ListRow) instead."); }
    
    @Deprecated
    @Override
    public void addActorAt(int index, Actor actor) { throw new OptimizationException("Use addItem(ListRow) instead."); }
    
    @Deprecated
    @Override
    public void addActorBefore(Actor actorBefore, Actor actor) { throw new OptimizationException("Use addItem(ListRow) instead."); }
    ...
    @Deprecated
    @Override
    public boolean removeActor(Actor actor) { return super.removeActor(actor); }
