...
public class MenuBar extends Panel
{
    ...
    @Deprecated
    @Override
    public Cell<?> add() { throw new OptimizationException("Use addContextMenu(Button, ContextMenu, Stage) instead."); };
    
    @Deprecated
    @Override
    public Cell<?> add(Actor actor)  { throw new OptimizationException("Use addContextMenu(Button, ContextMenu, Stage) instead."); }
    
    @Deprecated
    @Override
    public Cell<?> add(String text) { throw new OptimizationException("Use addContextMenu(Button, ContextMenu, Stage) instead."); }
    
    @Deprecated
    @Override
    public Cell<?> add(String text, String fontName, Color color) { throw new OptimizationException("Use addContextMenu(Button, ContextMenu, Stage) instead."); }
    
    @Deprecated
    @Override
    public Cell<?> add(String text, String fontName, String colorName) { throw new OptimizationException("Use addContextMenu(Button, ContextMenu, Stage) instead."); }
    
    @Deprecated
    @Override
    public Cell<?> add(String text, String labelStyleName) { throw new OptimizationException("Use addContextMenu(Button, ContextMenu, Stage) instead."); }
